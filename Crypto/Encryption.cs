...
internal static class Encryption
{
        ...
        BinaryReader inFileReader, BinaryWriter encryptedStreamBinWriter, bool logDisplay)
    {
        ...
        for (var i = 0; i < blockCount; i++)
        {
            ...
            var bytesToEncryptLowerValFixed = bytesToEncryptLowerVal & 0xFFFFFFFF;
            ...
            // and perform a XOR
            // operation
            var encryptedByte1 = computedBytesArray[0].LoopAByteReverse(xorTable, tableOffset);
            encryptedByte1 = ((currentBlockId ^ 69) & 255) ^ encryptedByte1;

            var encryptedByte2 = computedBytesArray[1].LoopAByteReverse(xorTable, tableOffset);
            encryptedByte2 = encryptedByte1 ^ encryptedByte2;

            var encryptedByte3 = computedBytesArray[2].LoopAByteReverse(xorTable, tableOffset);
            encryptedByte3 = encryptedByte2 ^ encryptedByte3;

            var encryptedByte4 = computedBytesArray[3].LoopAByteReverse(xorTable, tableOffset);
            encryptedByte4 = encryptedByte3 ^ encryptedByte4;

            var encryptedByte5 = computedBytesArray[4].LoopAByteReverse(xorTable, tableOffset);
            encryptedByte5 = encryptedByte4 ^ encryptedByte5;

            var encryptedByte6 = computedBytesArray[5].LoopAByteReverse(xorTable, tableOffset);
            encryptedByte6 = encryptedByte5 ^ encryptedByte6;

            var encryptedByte7 = computedBytesArray[6].LoopAByteReverse(xorTable, tableOffset);
            encryptedByte7 = encryptedByte6 ^ encryptedByte7;

            var encryptedByte8 = computedBytesArray[7].LoopAByteReverse(xorTable, tableOffset);
